...
MLfinalprojectWork.html: html rendering of the Rmd file. Does not calculate every neural net, but each model’s code is run. Most of the models run are simple with a hidden layer of 5 or 10 nodes. Simple modification of the code can be made to attain all results presented in paper. This html file also includes preliminary analysis with plots as well.
